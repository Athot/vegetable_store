...
<section class="shop_section layout_padding" style="padding-top: 0;">
    ...
    <div class="row">
      ...
      <form action="" method="POST">
        ...
        <div class="detail-boxs">
         <h6><?php echo $fetch_products['name']; ?></h6>
         ...
         <input type="submit" value="add to wishlist" name="add_to_wishlist" class="option-btn btn-primary ">
         <input type="submit" value="add to cart" name="add_to_cart" class="btn-danger">
            </div>
        </form>
       </div> <!-- close box div -->
      </div> <!-- close col div -->
