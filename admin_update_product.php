...
if(isset($_POST['update_product'])){
   ...
   $product_query = "INSERT INTO products(name, details, price, image, qty) VALUES ('$update_p_id', '$name', '$price', '$details', '$qty')";
   
   $product_query_run = mysqli_query($conn, $product_query);

   mysqli_query($conn, "UPDATE `products` SET name = '$name', details = '$details', qty = '$qty', price = '$price' WHERE id = '$update_p_id'") or die('query failed');
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="number" min="0" class="box" value="<?php echo $fetch_products['qty']; ?>" required placeholder="update product quantity" name="qty">
