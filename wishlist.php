     ...
     <!-- Start the product column -->
      ...
      <div class="box">
        ...
        <div class="detail-box">
            <div class="name">Name : <?php echo $fetch_wishlist['name']; ?></div>
...
<div class="more-btn">
        <a href="wishlist.php?delete_all" class="btn-danger" <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('delete all from wishlist?');">Delete all</a>
    </div>
    </div> 
    </div>
    </div>
